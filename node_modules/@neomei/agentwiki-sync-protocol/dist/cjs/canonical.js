...
exports.comparePushChanges = comparePushChanges;
...
function serialize(value, seen) {
    ...
    if (seen.has(value))
        throw new TypeError("Protocol values cannot be cyclic");
    seen.add(value);
    try {
...
function comparePushChanges(left, right) {
    const leftPath = "path" in left
        ? String(left.path)
        : "previousPath" in left
            ? String(left.previousPath)
            : "";
    const rightPath = "path" in right
        ? String(right.path)
        : "previousPath" in right
            ? String(right.previousPath)
            : "";
    return (compareCodePoints(left.pageId, right.pageId) ||

...
interface PushJournal {
  ...
  capabilitiesHash: string; changes: PushChange[]; sessionId: string | null; remoteState: "not_created" | "uploading" | "finalizing" | "published";
